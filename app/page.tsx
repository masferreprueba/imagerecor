    ...
    <main className="min-h-screen bg-[#f5f7f8] text-[#102321]">
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-5 py-10 sm:px-8 lg:grid-cols-[minmax(0,1fr)_360px] lg:py-14">
        ...
        <aside className="space-y-5 lg:pt-[172px]">
          <div className="rounded-[24px] bg-[#102321] p-6 text-white shadow-[0_20px_55px_rgba(16,35,33,.18)]"><div className="mb-6 flex items-center justify-between"><p className="font-black">Resultados incluidos</p><Sparkles className="size-5 text-[#ef312d]" /></div><div className="grid grid-cols-2 gap-3"><Stat value="500" label="PNG y JPEG" suffix="× 500" /><Stat value="1500" label="calidad estudio" suffix="× 1500" /><Stat value="+15%" label="escala centrada" /><Stat value="$0" label="costo adicional" /></div></div>
